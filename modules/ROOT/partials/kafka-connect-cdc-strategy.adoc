...
----
"neo4j.cdc.sourceId.topics": "<comma-separated list of topics>"
"neo4j.cdc.sourceId.labelName": "<the label attached to the node, default=SourceEvent>"
"neo4j.cdc.sourceId.idName": "<the id name given to the CDC id field, default=sourceId>"
----
...
[source,json,subs="verbatim,attributes"]
----
"neo4j.cdc.sourceId.topics": "topic.1,topic.2"
----
...
[source,json]
----
include::example$producer-data/node.created.json[]
----
...
[source,json,subs="verbatim,attributes"]
----
"{environment}.cdc.schema.topics": "<COMMA_SEPARATED_LIST_OF_TOPICS>"
----
...
[source,json,subs="verbatim,attributes"]
----
"{environment}.cdc.schema.topics": "topic.1,topic.2"
----
...
[source,json]
----
include::example$producer-data/relationship.created.json[]
----
