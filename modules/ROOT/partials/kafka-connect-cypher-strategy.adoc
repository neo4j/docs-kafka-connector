...
[source,json]
----
include::example$docker-data/sink.cypher.avro.neo4j.json[]
----
=====
...
[source,json]
----
include::example$docker-data/sink.cypher.json.neo4j.json[]
----
=====
...
[source,json]
----
include::example$docker-data/sink.cypher.json-string.neo4j.json[]
----
=====
====
