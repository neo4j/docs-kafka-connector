...
[IMPORTANT]
====
Starting with 5.1.0 version of the {product-name}, Cypher strategy will bind header, key and value of the messages as `\__header`, `__key` and `__value` respectively, which will be passed to the user provided Cypher query as predefined variables.
