...
For further details about error handling properties refers to xref:kafka-connect/sink.adoc#kafka_connect_error_handling[How deal with bad data] section
====
