...
The connector is designed to be compatible with versions of Apache Kafka Connect {kafka-connect-version} and later. Including Amazon MSK and Confluent Connect {confluent-connect-version}+ on the Confluent Platform and Cloud.
