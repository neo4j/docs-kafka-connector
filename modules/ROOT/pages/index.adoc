...
The {product-name} is designed for customers who want to stream data between Apache Kafka(R) and Neo4j or Aura databases using the Kafka Connect framework.

The connector supports several Kafka-based platforms:

* Confluent Platform(R) and Confluent Cloud(R)
* Open-source software (OSS) Apache Kafka(R)
* Amazon Managed Streaming for Apache Kafka (Amazon MSK(R))
