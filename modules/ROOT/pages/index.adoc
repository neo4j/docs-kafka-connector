...
The connector supports Neo4j 2025.x and 5.x, whether run as a managed service in link:{page-canonical-root}/aura/[Neo4j Aura], as a single instance, or as a cluster.
...
The connector is designed to be compatible with versions of Apache Kafka Connect {kafka-connect-version} and later.
This includes Amazon MSK and Confluent Connect {confluent-connect-version} and later on the Confluent Platform and Cloud.
