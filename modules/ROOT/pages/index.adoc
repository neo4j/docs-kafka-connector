...
The connector is designed to be compatible with versions of Apache Kafka Connect 3.4.1+. Including Amazon MSK and Confluent Connect 7.4+ on the Confluent Platform and Cloud.
