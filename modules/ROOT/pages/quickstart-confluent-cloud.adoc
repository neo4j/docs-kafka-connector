...
Follow link:{page-canonical-root}/cdc/current/get-started/aura[Enable CDC on Neo4j Aura] or link:{page-canonical-root}/cdc/current/get-started/on-prem[Enable CDC on Neo4j DBMS] for instructions.
