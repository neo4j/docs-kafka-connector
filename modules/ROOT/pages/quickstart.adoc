...
CDC Schema strategy will automatically build corresponding Cypher queries based on the incoming change event message.
...
[source,cypher]
----
MATCH (n:TestSource {name: 'mary', surname: 'ex-doe'}) DELETE n;
----
