...
[source,json]
----
include::ROOT:example$docker-data/quickstart.source.cdc.avro.neo4j.json[]
----
=====
...
[source,json]
----
include::ROOT:example$docker-data/quickstart.source.cdc.json.neo4j.json[]
----
=====
...
[source,json]
----
include::ROOT:example$docker-data/quickstart.source.cdc.json-string.neo4j.json[]
----
=====
====
...
[source,json]
----
include::ROOT:example$docker-data/quickstart.sink.avro.neo4j.json[]
----
=====
...
[source,json]
----
include::ROOT:example$docker-data/quickstart.sink.json.neo4j.json[]
----
=====
...
[source,json]
----
include::ROOT:example$docker-data/quickstart.sink.json-string.neo4j.json[]
----
=====
====
