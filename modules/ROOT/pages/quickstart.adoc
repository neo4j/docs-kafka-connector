...
[NOTE]
The following guide uses the {product-name} for Confluent, the provided Docker Compose file cannot be used as-is for Apache Kafka.
...
=====
ifdef::backend-pdf[]
.quickstart.source.cdc.json-string.json
endif::[]
[source,json]
----
include::example$docker-data/quickstart.source.cdc.json-string.json[]
----
=====
====
...
=====
ifdef::backend-pdf[]
.quickstart.sink.avro.json
endif::[]
[source,json]
----
include::example$docker-data/quickstart.sink.avro.json[]
----
=====
...
=====
ifdef::backend-pdf[]
.quickstart.sink.json.json
endif::[]
[source,json]
----
include::example$docker-data/quickstart.sink.json.json[]
----
=====
...
=====
ifdef::backend-pdf[]
.quickstart.sink.json-string.json
endif::[]
[source,json]
----
include::example$docker-data/quickstart.sink.json-string.json[]
----
=====
====
...
The properties `neo4j.cypher.topic.creates`, `neo4j.cypher.topic.updates` and `neo4j.cypher.topic.deletes` define the Cypher queries that will be executed per each message consumed by the sink instance on the Kafka Connect side.
