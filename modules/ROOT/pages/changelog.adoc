...
| The CDC Source connector now includes a configuration option to prefer querying the leader instance for CDC events, which can help reduce replication lag and improve the freshness of the data being captured.
