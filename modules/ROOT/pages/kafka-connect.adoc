...
[source,json]
----
include::ROOT:example$docker-data/contrib.sink.string-json.neo4j.json[]
----
...
include::partial$kafka-connect-sink-strategies.adoc[]

[#kafka-connect-cud-file-format]
include::partial$kafka-connect-cud-file-format.adoc[]
