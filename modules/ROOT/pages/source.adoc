...
label:current[Mandatory] One of `CDC`, `QUERY`
| neo4j.start-from | label:current[Mandatory] One of `EARLIEST`, `NOW`, `USER_PROVIDED`.
...
| neo4j.cdc.poll-interval | label:current[Mandatory] Interval duration between consecutive CDC polls in seconds, minutes, hours or days. Examples: `1d`, `2h`, `3m`, `4s`, `5ms`

Default: `10s`
| neo4j.cdc.poll-duration | label:current[Mandatory] CDC poll duration in seconds, minutes, hours or days. Examples: `1d`, `2h`, `3m`, `4s`, `5ms`
...
| neo4j.topic | label:current[Mandatory] Topic to write to
| neo4j.query | label:current[Mandatory] Read query to execute
| neo4j.query.streaming-property | label:current[Mandatory] Property to watch changes for
