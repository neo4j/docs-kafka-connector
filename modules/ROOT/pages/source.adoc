...
[source,json]
----
include::example$docker-data/source.cdc.avro.neo4j.json[]
----
=====
...
[source,json]
----
include::example$docker-data/source.cdc.json.neo4j.json[]
----
=====
...
[source,json]
----
include::example$docker-data/source.cdc.json-string.neo4j.json[]
----
=====
====
...
[source,json]
----
include::example$docker-data/source.query.avro.neo4j.json[]
----
=====
...
[source,json]
----
include::example$docker-data/source.query.json.neo4j.json[]
----
=====
...
[source,json]
----
include::example$docker-data/source.query.json-string.neo4j.json[]
----
=====
====
