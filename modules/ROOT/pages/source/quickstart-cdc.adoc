...
See xref:sink/quickstart-cdc.adoc[Quickstart: Sink with Change Data Capture] for that.
...
* xref:sink/quickstart-cdc.adoc[Quickstart: Sink with CDC] — apply these events to another Neo4j database.
