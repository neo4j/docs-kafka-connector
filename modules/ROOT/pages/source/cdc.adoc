...
For environments that support link:https://cwiki.apache.org/confluence/display/KAFKA/KIP-618%3A+Exactly-Once+Support+for+Source+Connectors[KIP-618: Exactly Once Support for Source Connectors], the CDC source connector will take advantage of this feature without any additional configuration.
